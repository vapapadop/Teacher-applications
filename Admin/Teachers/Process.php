...
//$epil_id=2;
   $QueryStr="DELETE FROM aithseis WHERE teacher_id='".$teacher_id."' AND epilogi_id='".$epilogi_id."'"; 
 ...
 if (isset($_POST['class_desc_new']))
	...
	$ep=$epilogi_id+1;
    if ($ep<=20) {
 	$QueryStr="INSERT INTO aithseis (teacher_id,epilogi_id,school_id) VALUES ('".$teacher_id."',".$ep.",'".$class_desc_new."')";
	$result=QueryDB($QueryStr,$connection);  
      }
  header("Location: editform.php");
  exit;  
